...
u32 wavelet_rank(const WaveletTree *wavelet, size_t l, size_t r, u32 k);

u32 wavelet_kth_smallest(const WaveletTree *wavelet, size_t l, size_t r, u32 k);

u32 wavelet_leq(const WaveletTree *wavelet, size_t l, size_t r, u32 k);
